...
class PIT_SISNR_mag(torch.nn.Module):
    ...
    def __post_init__(self):
        super(PIT_SISNR_mag, self).__init__()  # Initialize the torch.nn.Module base class
...
class PIT_SISNR_time(torch.nn.Module):
    ...
    def __post_init__(self):
        super(PIT_SISNR_time, self).__init__()  # Initialize the torch.nn.Module base class
...
@dataclass(slots=True)
class PIT_SISNRi(torch.nn.Module):
    device: torch.device
    num_spks: int
    scale_inv: bool

    def __post_init__(self):
        super(PIT_SISNRi, self).__init__()  # Initialize the torch.nn.Module base class
...
@dataclass(slots=True)
class PIT_SDRi(torch.nn.Module):
    device: torch.device
    dump: int

    def __post_init__(self):
        super(PIT_SDRi, self).__init__()  # Initialize the torch.nn.Module base class
